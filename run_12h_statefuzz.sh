...
cat <<EOF
[run_12h_statefuzz] Started.
[run_12h_statefuzz] Session      : $SESSION
[run_12h_statefuzz] Run log      : $RUN_LOG
[run_12h_statefuzz] Coverage log : $COVERAGE_LOG
[run_12h_staetfuzz] Hourly dir   : $HOURLY_DIR
[run_12h_statefuzz] Hourly sum   : $HOURLY_SUMMARY
